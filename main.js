...
var song1 = new Song("1 Roxanne", "The Police", "Outlandos d'Amour");
...
$("#addbtn").click(function(){
	...
	$("#paragraph").html("<p>" + title + " " + artist + " " + album + " will be added just as soon as we get the back end set up!</p>");
